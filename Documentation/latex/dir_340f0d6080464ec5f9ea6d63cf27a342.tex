\doxysection{C\+:/\+Users/saket/\+One\+Drive/\+Desktop/e\+Pathshala/epathshala-\/\+Web/node\+\_\+modules/flat-\/cache Directory Reference}
\hypertarget{dir_340f0d6080464ec5f9ea6d63cf27a342}{}\label{dir_340f0d6080464ec5f9ea6d63cf27a342}\index{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/flat-\/cache Directory Reference@{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/flat-\/cache Directory Reference}}
Directory dependency graph for flat-\/cache\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=175pt]{dir_340f0d6080464ec5f9ea6d63cf27a342_dep}
\end{center}
\end{figure}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md11288}{}\doxysubsection{\texorpdfstring{flat-\/cache}{flat-\/cache}}\label{README.md_autotoc_md11288}
\begin{quote}
A stupidly simple key/value storage using files to persist the data \end{quote}


\href{https://npmjs.org/package/flat-cache}{\texttt{}} \href{https://github.com/jaredwray/flat-cache/actions/workflows/tests.yaml}{\texttt{}} \href{https://codecov.io/github/jaredwray/flat-cache}{\texttt{}} \href{https://npmjs.com/package/flat-cache}{\texttt{}}\hypertarget{README.md_autotoc_md11289}{}\doxysubsection{\texorpdfstring{install}{install}}\label{README.md_autotoc_md11289}

\begin{DoxyCode}{0}
\DoxyCodeLine{npm\ i\ -\/-\/save\ flat-\/cache}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md11290}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md11290}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11291}{}\doxysubsection{\texorpdfstring{Motivation for this module}{Motivation for this module}}\label{README.md_autotoc_md11291}
I needed a super simple and dumb {\bfseries{in-\/memory cache}} with optional disk persistance in order to make a script that will beutify files with {\ttfamily esformatter} only execute on the files that were changed since the last run. To make that possible we need to store the {\ttfamily file\+Size} and {\ttfamily modification\+Time} of the files. So a simple {\ttfamily key/value} storage was needed and Bam! this module was born.\hypertarget{README.md_autotoc_md11292}{}\doxysubsection{\texorpdfstring{Important notes}{Important notes}}\label{README.md_autotoc_md11292}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md11293}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md11293}
MIT\hypertarget{README.md_autotoc_md11294}{}\doxysubsection{\texorpdfstring{Changelog}{Changelog}}\label{README.md_autotoc_md11294}
\doxysectlink{md__c_1_2_users_2saket_2_one_drive_2_desktop_2e_pathshala_2epathshala-_web_2node__modules_2flat-cache_2changelog}{changelog}{0} 