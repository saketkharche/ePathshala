\doxysection{C\+:/\+Users/saket/\+One\+Drive/\+Desktop/e\+Pathshala/epathshala-\/\+Web/node\+\_\+modules/faye-\/websocket Directory Reference}
\hypertarget{dir_39e47cbce54ab25ad65886f807f2c6b7}{}\label{dir_39e47cbce54ab25ad65886f807f2c6b7}\index{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/faye-\/websocket Directory Reference@{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/faye-\/websocket Directory Reference}}
Directory dependency graph for faye-\/websocket\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=198pt]{dir_39e47cbce54ab25ad65886f807f2c6b7_dep}
\end{center}
\end{figure}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md11166}{}\doxysubsection{\texorpdfstring{faye-\/websocket}{faye-\/websocket}}\label{README.md_autotoc_md11166}
...
It also provides an abstraction for handling \href{https://html.spec.whatwg.org/multipage/comms.html\#server-sent-events}{\texttt{Event\+Source}} connections, which are one-\/way connections that allow the server to push data to the client. They are based on streaming HTTP responses and can be easier to access via proxies than Web\+Sockets.\hypertarget{README.md_autotoc_md11167}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md11167}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ faye-\/websocket}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md11168}{}\doxysubsection{\texorpdfstring{Handling Web\+Socket connections in Node}{Handling Web\+Socket connections in Node}}\label{README.md_autotoc_md11168}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11169}{}\doxysubsection{\texorpdfstring{Using the Web\+Socket client}{Using the Web\+Socket client}}\label{README.md_autotoc_md11169}
...
The {\ttfamily tls} value is an object that will be passed to \href{https://nodejs.org/api/tls.html\#tls_tls_connect_options_callback}{\texttt{{\ttfamily tls.\+connect()}}}.\hypertarget{README.md_autotoc_md11170}{}\doxysubsection{\texorpdfstring{Subprotocol negotiation}{Subprotocol negotiation}}\label{README.md_autotoc_md11170}
...
If the client and server agree on a protocol, both the client-\/ and server-\/side socket objects expose the selected protocol through the {\ttfamily ws.\+protocol} property.\hypertarget{README.md_autotoc_md11171}{}\doxysubsection{\texorpdfstring{Protocol extensions}{Protocol extensions}}\label{README.md_autotoc_md11171}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11172}{}\doxysubsection{\texorpdfstring{Initialization options}{Initialization options}}\label{README.md_autotoc_md11172}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md11173}{}\doxysubsection{\texorpdfstring{Web\+Socket API}{Web\+Socket API}}\label{README.md_autotoc_md11173}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md11174}{}\doxysubsection{\texorpdfstring{Handling Event\+Source connections in Node}{Handling Event\+Source connections in Node}}\label{README.md_autotoc_md11174}
