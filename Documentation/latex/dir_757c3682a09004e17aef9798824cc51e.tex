\doxysection{C\+:/\+Users/saket/\+One\+Drive/\+Desktop/e\+Pathshala/epathshala-\/\+Web/node\+\_\+modules/keyv Directory Reference}
\hypertarget{dir_757c3682a09004e17aef9798824cc51e}{}\label{dir_757c3682a09004e17aef9798824cc51e}\index{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/keyv Directory Reference@{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/keyv Directory Reference}}
Directory dependency graph for keyv\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=175pt]{dir_757c3682a09004e17aef9798824cc51e_dep}
\end{center}
\end{figure}
...
Keyv provides a consistent interface for key-\/value storage across multiple backends via storage adapters. It supports TTL based expiry, making it suitable as a cache or a persistent key-\/value store.\hypertarget{README.md_autotoc_md11955}{}\doxysubsubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md11955}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md11956}{}\doxysubsubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md11956}
Install Keyv.
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11957}{}\doxysubsubsubsection{\texorpdfstring{Namespaces}{Namespaces}}\label{README.md_autotoc_md11957}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11958}{}\doxysubsubsubsection{\texorpdfstring{Custom Serializers}{Custom Serializers}}\label{README.md_autotoc_md11958}
...
\end{longtabu}
\hypertarget{README.md_autotoc_md11960}{}\doxysubsubsection{\texorpdfstring{Third-\/party Storage Adapters}{Third-\/party Storage Adapters}}\label{README.md_autotoc_md11960}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md11961}{}\doxysubsubsection{\texorpdfstring{Add Cache Support to your Module}{Add Cache Support to your Module}}\label{README.md_autotoc_md11961}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11962}{}\doxysubsubsection{\texorpdfstring{Compression}{Compression}}\label{README.md_autotoc_md11962}
...
You can also pass a custom compression function to the {\ttfamily compression} option. Following the pattern of the official compression adapters.\hypertarget{README.md_autotoc_md11963}{}\doxysubsubsubsection{\texorpdfstring{Want to build your own?}{Want to build your own?}}\label{README.md_autotoc_md11963}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11964}{}\doxysubsubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md11964}
\hypertarget{README.md_autotoc_md11965}{}\doxysubsubsubsection{\texorpdfstring{new Keyv(\mbox{[}uri\mbox{]}, \mbox{[}options\mbox{]})}{new Keyv(\mbox{[}uri\mbox{]}, \mbox{[}options\mbox{]})}}\label{README.md_autotoc_md11965}
Returns a new Keyv instance.

The Keyv instance is also an {\ttfamily Event\+Emitter} that will emit an `\textquotesingle{}error'\`{} event if the storage adapter connection fails.\hypertarget{README.md_autotoc_md11966}{}\doxysubsubsubsection{\texorpdfstring{uri}{uri}}\label{README.md_autotoc_md11966}
Type\+: {\ttfamily String}~\newline
 Default\+: {\ttfamily undefined}

The connection string URI.

Merged into the options object as options.\+uri.\hypertarget{README.md_autotoc_md11967}{}\doxysubsubsubsection{\texorpdfstring{options}{options}}\label{README.md_autotoc_md11967}
Type\+: {\ttfamily Object}

The options object is also passed through to the storage adapter. Check your storage adapter docs for any extra options.\hypertarget{README.md_autotoc_md11968}{}\doxysubsubsubsubsection{\texorpdfstring{options.\+namespace}{options.\+namespace}}\label{README.md_autotoc_md11968}
Type\+: {\ttfamily String}~\newline
 Default\+: `\textquotesingle{}keyv'\`{}

Namespace for the current instance.\hypertarget{README.md_autotoc_md11969}{}\doxysubsubsubsubsection{\texorpdfstring{options.\+ttl}{options.\+ttl}}\label{README.md_autotoc_md11969}
Type\+: {\ttfamily Number}~\newline
 Default\+: {\ttfamily undefined}

Default TTL. Can be overridden by specififying a TTL on {\ttfamily .set()}.\hypertarget{README.md_autotoc_md11970}{}\doxysubsubsubsubsection{\texorpdfstring{options.\+compression}{options.\+compression}}\label{README.md_autotoc_md11970}
Type\+: {\ttfamily @keyv/compress-\/\texorpdfstring{$<$}{<}compression\+\_\+package\+\_\+name\texorpdfstring{$>$}{>}}~\newline
 Default\+: {\ttfamily undefined}

Compression package to use. See Compression for more details.\hypertarget{README.md_autotoc_md11971}{}\doxysubsubsubsubsection{\texorpdfstring{options.\+serialize}{options.\+serialize}}\label{README.md_autotoc_md11971}
Type\+: {\ttfamily Function}~\newline
 Default\+: {\ttfamily JSONB.\+stringify}

A custom serialization function.\hypertarget{README.md_autotoc_md11972}{}\doxysubsubsubsubsection{\texorpdfstring{options.\+deserialize}{options.\+deserialize}}\label{README.md_autotoc_md11972}
Type\+: {\ttfamily Function}~\newline
 Default\+: {\ttfamily JSONB.\+parse}

A custom deserialization function.\hypertarget{README.md_autotoc_md11973}{}\doxysubsubsubsubsection{\texorpdfstring{options.\+store}{options.\+store}}\label{README.md_autotoc_md11973}
Type\+: {\ttfamily Storage adapter instance}~\newline
 Default\+: {\ttfamily new Map()}

The storage adapter instance to be used by Keyv.\hypertarget{README.md_autotoc_md11974}{}\doxysubsubsubsubsection{\texorpdfstring{options.\+adapter}{options.\+adapter}}\label{README.md_autotoc_md11974}
Type\+: {\ttfamily String}~\newline
 Default\+: {\ttfamily undefined}

Specify an adapter to use. e.\+g `\textquotesingle{}redis'{\ttfamily  or }\textquotesingle{}mongodb\textquotesingle{}\`{}.\hypertarget{README.md_autotoc_md11975}{}\doxysubsubsubsection{\texorpdfstring{Instance}{Instance}}\label{README.md_autotoc_md11975}
Keys must always be strings. Values can be of any type.\hypertarget{README.md_autotoc_md11976}{}\doxysubsubsubsubsection{\texorpdfstring{.set(key, value, \mbox{[}ttl\mbox{]})}{.set(key, value, \mbox{[}ttl\mbox{]})}}\label{README.md_autotoc_md11976}
Set a value.

By default keys are persistent. You can set an expiry TTL in milliseconds.

Returns a promise which resolves to {\ttfamily true}.\hypertarget{README.md_autotoc_md11977}{}\doxysubsubsubsubsection{\texorpdfstring{.get(key, \mbox{[}options\mbox{]})}{.get(key, \mbox{[}options\mbox{]})}}\label{README.md_autotoc_md11977}
Returns a promise which resolves to the retrieved value.\hypertarget{README.md_autotoc_md11978}{}\doxysubsubsubsubsubsection{\texorpdfstring{options.\+raw}{options.\+raw}}\label{README.md_autotoc_md11978}
Type\+: {\ttfamily Boolean}~\newline
 Default\+: {\ttfamily false}

If set to true the raw DB object Keyv stores internally will be returned instead of just the value.

This contains the TTL timestamp.\hypertarget{README.md_autotoc_md11979}{}\doxysubsubsubsubsection{\texorpdfstring{.delete(key)}{.delete(key)}}\label{README.md_autotoc_md11979}
Deletes an entry.

Returns a promise which resolves to {\ttfamily true} if the key existed, {\ttfamily false} if not.\hypertarget{README.md_autotoc_md11980}{}\doxysubsubsubsubsection{\texorpdfstring{.clear()}{.clear()}}\label{README.md_autotoc_md11980}
Delete all entries in the current namespace.

Returns a promise which is resolved when the entries have been cleared.\hypertarget{README.md_autotoc_md11981}{}\doxysubsubsubsubsection{\texorpdfstring{.iterator()}{.iterator()}}\label{README.md_autotoc_md11981}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md11982}{}\doxysubsection{\texorpdfstring{How to Contribute}{How to Contribute}}\label{README.md_autotoc_md11982}
In this section of the documentation we will cover\+:

1) How to set up this repository locally 2) How to get started with running commands 3) How to contribute changes using Pull Requests\hypertarget{README.md_autotoc_md11983}{}\doxysubsubsection{\texorpdfstring{Dependencies}{Dependencies}}\label{README.md_autotoc_md11983}
This package requires the following dependencies to run\+:

1) \href{https://yarnpkg.com/getting-started/install}{\texttt{Yarn V1}} 3) \href{https://docs.docker.com/get-docker/}{\texttt{Docker}}\hypertarget{README.md_autotoc_md11984}{}\doxysubsubsection{\texorpdfstring{Setting up your workspace}{Setting up your workspace}}\label{README.md_autotoc_md11984}
To contribute to this repository, start by setting up this project locally\+:

1) Fork this repository into your Git account 2) Clone the forked repository to your local directory using {\ttfamily git clone} 3) Install any of the above missing dependencies\hypertarget{README.md_autotoc_md11985}{}\doxysubsubsection{\texorpdfstring{Launching the project}{Launching the project}}\label{README.md_autotoc_md11985}
Once the project is installed locally, you are ready to start up its services\+:

1) Ensure that your Docker service is running. 2) From the root directory of your project, run the {\ttfamily yarn} command in the command prompt to install yarn. 3) Run the {\ttfamily yarn bootstrap} command to install any necessary dependencies. 4) Run {\ttfamily yarn test\+:services\+:start} to start up this project\textquotesingle{}s Docker container. The container will launch all services within your workspace.\hypertarget{README.md_autotoc_md11986}{}\doxysubsubsection{\texorpdfstring{Available Commands}{Available Commands}}\label{README.md_autotoc_md11986}
...
Here, we\textquotesingle{}ll cover the primary commands that can be executed from the root directory. Unless otherwise noted, these commands can also be executed from a subpackage. If executed from a subpackage, they will only affect that subpackage, rather than the entire workspace.\hypertarget{README.md_autotoc_md11987}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily yarn}}{{\ttfamily yarn}}}\label{README.md_autotoc_md11987}
The {\ttfamily yarn} command installs yarn in the workspace.\hypertarget{README.md_autotoc_md11988}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily yarn bootstrap}}{{\ttfamily yarn bootstrap}}}\label{README.md_autotoc_md11988}
The {\ttfamily yarn bootstrap} command installs all dependencies in the workspace.\hypertarget{README.md_autotoc_md11989}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily yarn test\+:services\+:start}}{{\ttfamily yarn test\+:services\+:start}}}\label{README.md_autotoc_md11989}
The {\ttfamily yarn test\+:services\+:start} command starts up the project\textquotesingle{}s Docker container, launching all services in the workspace. This command must be executed from the root directory.\hypertarget{README.md_autotoc_md11990}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily yarn test\+:services\+:stop}}{{\ttfamily yarn test\+:services\+:stop}}}\label{README.md_autotoc_md11990}
The {\ttfamily yarn test\+:services\+:stop} command brings down the project\textquotesingle{}s Docker container, halting all services. This command must be executed from the root directory.\hypertarget{README.md_autotoc_md11991}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily yarn test}}{{\ttfamily yarn test}}}\label{README.md_autotoc_md11991}
The {\ttfamily yarn test} command runs all tests in the workspace.\hypertarget{README.md_autotoc_md11992}{}\doxysubsubsubsection{\texorpdfstring{{\ttfamily yarn clean}}{{\ttfamily yarn clean}}}\label{README.md_autotoc_md11992}
The {\ttfamily yarn clean} command removes yarn and all dependencies installed by yarn. After executing this command, you must repeat the steps in {\itshape Setting up your workspace} to rebuild your workspace.\hypertarget{README.md_autotoc_md11993}{}\doxysubsubsection{\texorpdfstring{Contributing Changes}{Contributing Changes}}\label{README.md_autotoc_md11993}
...
If you need more information on the steps to create a pull request, you can find a detailed walkthrough in the \href{https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request-from-a-fork}{\texttt{Github documentation}}\hypertarget{README.md_autotoc_md11994}{}\doxysubsubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md11994}
MIT © Jared Wray 
