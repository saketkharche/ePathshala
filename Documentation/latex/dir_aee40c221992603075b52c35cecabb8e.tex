\doxysection{C\+:/\+Users/saket/\+One\+Drive/\+Desktop/e\+Pathshala/epathshala-\/\+Web/node\+\_\+modules/cosmiconfig Directory Reference}
\hypertarget{dir_aee40c221992603075b52c35cecabb8e}{}\label{dir_aee40c221992603075b52c35cecabb8e}\index{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/cosmiconfig Directory Reference@{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/cosmiconfig Directory Reference}}
Directory dependency graph for cosmiconfig\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=294pt]{dir_aee40c221992603075b52c35cecabb8e_dep}
\end{center}
\end{figure}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \mbox{\hyperlink{dir_32fdd7edb06c67d170862554c9229f0b}{node\+\_\+modules}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md10477}{}\doxysubsection{\texorpdfstring{cosmiconfig}{cosmiconfig}}\label{README.md_autotoc_md10477}
...
Cosmiconfig continues to search up the directory tree, checking each of these places in each directory, until it finds some acceptable configuration (or hits the home directory).\hypertarget{README.md_autotoc_md10478}{}\doxysubsection{\texorpdfstring{Table of contents}{Table of contents}}\label{README.md_autotoc_md10478}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md10479}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md10479}
...
Tested in Node 10+.\hypertarget{README.md_autotoc_md10480}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md10480}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10481}{}\doxysubsection{\texorpdfstring{Result}{Result}}\label{README.md_autotoc_md10481}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md10482}{}\doxysubsection{\texorpdfstring{Asynchronous API}{Asynchronous API}}\label{README.md_autotoc_md10482}
\hypertarget{README.md_autotoc_md10483}{}\doxysubsubsection{\texorpdfstring{cosmiconfig()}{cosmiconfig()}}\label{README.md_autotoc_md10483}
...
Creates a cosmiconfig instance ("{}explorer"{}) configured according to the arguments, and initializes its caches.\hypertarget{README.md_autotoc_md10484}{}\doxysubsubsubsection{\texorpdfstring{module\+Name}{module\+Name}}\label{README.md_autotoc_md10484}
...
{\bfseries{\`{}cosmiconfig\+Options\`{} are documented below.}} You may not need them, and should first read about the functions you\textquotesingle{}ll use.\hypertarget{README.md_autotoc_md10485}{}\doxysubsubsection{\texorpdfstring{explorer.\+search()}{explorer.\+search()}}\label{README.md_autotoc_md10485}
...
{\bfseries{The search process is highly customizable.}} Use the cosmiconfig options \`{}search\+Places\`{} and \`{}loaders\`{} to precisely define where you want to look for configurations and how you want to load them.\hypertarget{README.md_autotoc_md10486}{}\doxysubsubsubsection{\texorpdfstring{search\+From}{search\+From}}\label{README.md_autotoc_md10486}
Type\+: {\ttfamily string}. Default\+: {\ttfamily process.\+cwd()}.

A filename. \`{}search()\`{} will start its search here.

If the value is a directory, that\textquotesingle{}s where the search starts. If it\textquotesingle{}s a file, the search starts in that file\textquotesingle{}s directory.\hypertarget{README.md_autotoc_md10487}{}\doxysubsubsection{\texorpdfstring{explorer.\+load()}{explorer.\+load()}}\label{README.md_autotoc_md10487}
...
You can do the same thing synchronously with \`{}explorer\+Sync.load()\`{}.\hypertarget{README.md_autotoc_md10488}{}\doxysubsubsection{\texorpdfstring{explorer.\+clear\+Load\+Cache()}{explorer.\+clear\+Load\+Cache()}}\label{README.md_autotoc_md10488}
Clears the cache used in \`{}load()\`{}.\hypertarget{README.md_autotoc_md10489}{}\doxysubsubsection{\texorpdfstring{explorer.\+clear\+Search\+Cache()}{explorer.\+clear\+Search\+Cache()}}\label{README.md_autotoc_md10489}
Clears the cache used in \`{}search()\`{}.\hypertarget{README.md_autotoc_md10490}{}\doxysubsubsection{\texorpdfstring{explorer.\+clear\+Caches()}{explorer.\+clear\+Caches()}}\label{README.md_autotoc_md10490}
Performs both \`{}clear\+Load\+Cache()\`{} and \`{}clear\+Search\+Cache()\`{}.\hypertarget{README.md_autotoc_md10491}{}\doxysubsection{\texorpdfstring{Synchronous API}{Synchronous API}}\label{README.md_autotoc_md10491}
\hypertarget{README.md_autotoc_md10492}{}\doxysubsubsection{\texorpdfstring{cosmiconfig\+Sync()}{cosmiconfig\+Sync()}}\label{README.md_autotoc_md10492}
...
See \`{}cosmiconfig()\`{}.\hypertarget{README.md_autotoc_md10493}{}\doxysubsubsection{\texorpdfstring{explorer\+Sync.\+search()}{explorer\+Sync.\+search()}}\label{README.md_autotoc_md10493}
...
Returns a result or {\ttfamily null}.\hypertarget{README.md_autotoc_md10494}{}\doxysubsubsection{\texorpdfstring{explorer\+Sync.\+load()}{explorer\+Sync.\+load()}}\label{README.md_autotoc_md10494}
...
Returns a result.\hypertarget{README.md_autotoc_md10495}{}\doxysubsubsection{\texorpdfstring{explorer\+Sync.\+clear\+Load\+Cache()}{explorer\+Sync.\+clear\+Load\+Cache()}}\label{README.md_autotoc_md10495}
Clears the cache used in \`{}load()\`{}.\hypertarget{README.md_autotoc_md10496}{}\doxysubsubsection{\texorpdfstring{explorer\+Sync.\+clear\+Search\+Cache()}{explorer\+Sync.\+clear\+Search\+Cache()}}\label{README.md_autotoc_md10496}
Clears the cache used in \`{}search()\`{}.\hypertarget{README.md_autotoc_md10497}{}\doxysubsubsection{\texorpdfstring{explorer\+Sync.\+clear\+Caches()}{explorer\+Sync.\+clear\+Caches()}}\label{README.md_autotoc_md10497}
Performs both \`{}clear\+Load\+Cache()\`{} and \`{}clear\+Search\+Cache()\`{}.\hypertarget{README.md_autotoc_md10498}{}\doxysubsection{\texorpdfstring{cosmiconfig\+Options}{cosmiconfig\+Options}}\label{README.md_autotoc_md10498}
Type\+: {\ttfamily Object}.

Possible options are documented below.\hypertarget{README.md_autotoc_md10499}{}\doxysubsubsection{\texorpdfstring{search\+Places}{search\+Places}}\label{README.md_autotoc_md10499}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10500}{}\doxysubsubsection{\texorpdfstring{loaders}{loaders}}\label{README.md_autotoc_md10500}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10501}{}\doxysubsubsection{\texorpdfstring{package\+Prop}{package\+Prop}}\label{README.md_autotoc_md10501}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md10502}{}\doxysubsubsection{\texorpdfstring{stop\+Dir}{stop\+Dir}}\label{README.md_autotoc_md10502}
Type\+: {\ttfamily string}. Default\+: Absolute path to your home directory.

Directory where the search will stop.\hypertarget{README.md_autotoc_md10503}{}\doxysubsubsection{\texorpdfstring{cache}{cache}}\label{README.md_autotoc_md10503}
Type\+: {\ttfamily boolean}. Default\+: {\ttfamily true}.

If {\ttfamily false}, no caches will be used. Read more about "{}Caching"{} below.\hypertarget{README.md_autotoc_md10504}{}\doxysubsubsection{\texorpdfstring{transform}{transform}}\label{README.md_autotoc_md10504}
...
Why might you want to load empty configuration files? If you want to throw an error, or if an empty configuration file means something to your program.\hypertarget{README.md_autotoc_md10506}{}\doxysubsection{\texorpdfstring{Caching}{Caching}}\label{README.md_autotoc_md10506}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md10507}{}\doxysubsection{\texorpdfstring{Differences from \href{https://github.com/dominictarr/rc}{\texttt{rc}}}{Differences from \href{https://github.com/dominictarr/rc}{\texttt{rc}}}}\label{README.md_autotoc_md10507}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md10508}{}\doxysubsection{\texorpdfstring{Contributing \& Development}{Contributing \& Development}}\label{README.md_autotoc_md10508}
Please note that this project is released with a \doxylink{_c_o_d_e___o_f___c_o_n_d_u_c_t_8md}{Contributor Code of Conduct}. By participating in this project you agree to abide by its terms.
