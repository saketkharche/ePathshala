\doxysection{C\+:/\+Users/saket/\+One\+Drive/\+Desktop/e\+Pathshala/epathshala-\/\+Web/node\+\_\+modules/@eslint/config-\/array Directory Reference}
\hypertarget{dir_dfab6749d34e8ddc2b2cb5c4cbf59cce}{}\label{dir_dfab6749d34e8ddc2b2cb5c4cbf59cce}\index{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/"@eslint/config-\/array Directory Reference@{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/"@eslint/config-\/array Directory Reference}}
Directory dependency graph for config-\/array\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=180pt]{dir_dfab6749d34e8ddc2b2cb5c4cbf59cce_dep}
\end{center}
\end{figure}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md532}{}\doxysubsection{\texorpdfstring{Config Array}{Config Array}}\label{README.md_autotoc_md532}
\hypertarget{README.md_autotoc_md533}{}\doxysubsection{\texorpdfstring{Description}{Description}}\label{README.md_autotoc_md533}
...
{\bfseries{Note\+:}} This is a generic package that can be used outside of ESLint. It contains no ESLint-\/specific functionality.\hypertarget{README.md_autotoc_md534}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md534}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md535}{}\doxysubsection{\texorpdfstring{Background}{Background}}\label{README.md_autotoc_md535}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md538}{}\doxysubsubsection{\texorpdfstring{Config Arrays}{Config Arrays}}\label{README.md_autotoc_md538}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md539}{}\doxysubsubsection{\texorpdfstring{Config Functions}{Config Functions}}\label{README.md_autotoc_md539}
...
{\bfseries{Note\+:}} Config functions can also be async.\hypertarget{README.md_autotoc_md540}{}\doxysubsubsection{\texorpdfstring{Normalizing Config Arrays}{Normalizing Config Arrays}}\label{README.md_autotoc_md540}
...
{\bfseries{Important\+:}} Once a {\ttfamily Config\+Array} is normalized, it cannot be changed further. You can, however, create a new {\ttfamily Config\+Array} and pass in the normalized instance to create an unnormalized copy.\hypertarget{README.md_autotoc_md541}{}\doxysubsubsection{\texorpdfstring{Getting Config for a File}{Getting Config for a File}}\label{README.md_autotoc_md541}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md542}{}\doxysubsection{\texorpdfstring{Determining Ignored Paths}{Determining Ignored Paths}}\label{README.md_autotoc_md542}
...
{\bfseries{Important\+:}} A pattern such as {\ttfamily foo/\texorpdfstring{$\ast$}{*}\texorpdfstring{$\ast$}{*}} means that {\ttfamily foo} and {\ttfamily foo/} are {\itshape not} ignored whereas {\ttfamily foo/bar} is ignored. If you want to ignore {\ttfamily foo} and all of its subdirectories, use the pattern {\ttfamily foo} or {\ttfamily foo/} in {\ttfamily ignores}.\hypertarget{README.md_autotoc_md543}{}\doxysubsection{\texorpdfstring{Caching Mechanisms}{Caching Mechanisms}}\label{README.md_autotoc_md543}
...
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md544}{}\doxysubsection{\texorpdfstring{Acknowledgements}{Acknowledgements}}\label{README.md_autotoc_md544}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md545}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md545}
Apache 2.\+0\hypertarget{README.md_autotoc_md546}{}\doxysubsection{\texorpdfstring{Sponsors}{Sponsors}}\label{README.md_autotoc_md546}
