\doxysection{C\+:/\+Users/saket/\+One\+Drive/\+Desktop/e\+Pathshala/epathshala-\/\+Web/node\+\_\+modules/dom-\/helpers Directory Reference}
\hypertarget{dir_e9c14d7708cadc4ea0094a52c19e49c9}{}\label{dir_e9c14d7708cadc4ea0094a52c19e49c9}\index{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/dom-\/helpers Directory Reference@{C:/Users/saket/OneDrive/Desktop/ePathshala/epathshala-\/Web/node\_modules/dom-\/helpers Directory Reference}}
Directory dependency graph for dom-\/helpers\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=182pt]{dir_e9c14d7708cadc4ea0094a52c19e49c9_dep}
\end{center}
\end{figure}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md10722}{}\doxysubsection{\texorpdfstring{dom-\/helpers}{dom-\/helpers}}\label{README.md_autotoc_md10722}
tiny modular DOM lib for ie9+\hypertarget{README.md_autotoc_md10723}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md10723}
...
\item {\ttfamily filter(selector, fn)}\+: returns a function handler that only fires when the target matches or is contained in the selector ex\+: `on(list, \textquotesingle{}click', filter(\textquotesingle{}li \texorpdfstring{$>$}{>} a\textquotesingle{}, handler)){\ttfamily }
\item {\ttfamily }request\+Animation\+Frame(cb){\ttfamily  returns an ID for canceling}
\item {\ttfamily }cancel\+Animation\+Frame(id){\ttfamily }
\item {\ttfamily }scrollbar\+Size(\mbox{[}recalc\mbox{]}){\ttfamily  returns the scrollbar\textquotesingle{}s width size in pixels}
