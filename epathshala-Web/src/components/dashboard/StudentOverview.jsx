...
const statsCards = [
  {
    ...
    icon: AssignmentIcon,
    color: '#f57c00',
    description: 'Assignments to be submitted'
  },
  {
...
const recentActivities = [
  {
    type: 'assignment',
    text: 'Math Homework due in 2 days',
    time: '2 hours ago',
    status: 'pending'
  },
  {
    type: 'exam',
    text: 'Mathematics Mid-Term completed',
    time: '1 day ago',
    status: 'completed'
  },
  {
    type: 'grade',
    text: 'Science grade updated to A+',
    time: '2 days ago',
    status: 'completed'
  },
  {
...
function StudentOverview() {
  ...
  const getActivityIcon = (type) => {
    switch (type) {
      ...
      case 'leave': return <ScheduleIcon color="info" />;
  ...
  return (
    <Box>
      ...
      <Box sx={{ mb: { xs: 3, md: 4 } }}>
        ...
        >
          Track your academic progress, manage assignments, and stay on top of your studies
        </Typography>
      </Box>
